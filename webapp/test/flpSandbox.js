		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "test",
									"targetURL": "#zgvtcommodityuploadtest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zgvtcommodityuploadtest-display": {
								"semanticObject": "zgvtcommodityuploadtest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zgvt.commodity.upload.test",
									"url": sap.ui.require.toUrl("zgvt/commodity/upload/test")
								}
							}
						}
					}
